...
import configs, { dir, dll, compiler, directory, theme, general, optimizer } from './.vd/project.json';
...
export default {
  ...
  plugins: [
    ...
    new CopyPlugin([
      {
        context: __dirname,
        from: join(__dirname, directory.development.envName, directory.development.config, 'canvas2image.js'),
        to: join(__dirname, directory.production.envName, directory.production.resource, directory.production.javascript),
      }
    ]),
  ],
